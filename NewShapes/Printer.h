...
protected:
	...
	char board[61][121];
public:
	void InsertLine(const TVector<Type>& _vec1, const TVector<Type>& _vec2);
	...
	void InsertCircle(const TVector<Type>& _vec1);
	void ToPrint();
	void clear();
...
inline void Printer<Type>::InsertLine(float x1, float y1, float x2, float y2)
{
	...
	std::cout << "x1 = " << xx1 << ' ' << "y1 = " << yy1 << std::endl;
	std::cout << "x2 = " << xx2 << ' ' << "y2 = " << yy2 << std::endl;
...
template<class Type>
inline void Printer<Type>::InsertLine(const TVector<Type>& _vec1, const TVector<Type>& _vec2)
{
	TVector<Type> temp1 = _vec1;
	TVector<Type> temp2 = _vec2;
...
template<class Type>
inline void Printer<Type>::InsertCircle(const TVector<Type>& _vec1)
{
